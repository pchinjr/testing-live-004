...
exports.handler = async function http (req) {
  let height = [200, 400, 600]
  let width = [200, 400, 600]
    ...
    <div class="margin-left-8">
      <div class="margin-bottom-16">
        ...
        <p class="margin-bottom-8">
          <img src="https://www.placecage.com/gif/${height[Math.floor(Math.random() * height.length)]}/${width[Math.floor(Math.random() * height.length)]}" />
        </p>
        <code>
